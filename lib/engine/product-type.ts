...
export const PRODUCT_TYPE_RULES: ProductTypeRule[] = [
  { pattern: /\bcamera lens protectors?\b/, type: "camera lens protector" },
  { pattern: /\bscreen protectors?\b/, type: "screen protector" },
  { pattern: /\bselfie stick\b/, type: "selfie stick" },
  { pattern: /\bwireless chargers?\b/, type: "wireless charger" },
  { pattern: /\bwl chgr\b/, type: "wall charger" },
  { pattern: /\bwall chargers?\b/, type: "wall charger" },
  { pattern: /\bcar chargers?\b/, type: "car charger" },
  ...
  { pattern: /\bring lights?\b/, type: "ring light" },
  { pattern: /\bbluetooth earbuds?\b/, type: "earbuds" },
  { pattern: /\bearbuds?\b/, type: "earbuds" },
  { pattern: /\bheadphones?\b/, type: "headphones" },
  { pattern: /\bchargers?\b/, type: "charger" },
  { pattern: /\bcables?\b/, type: "cable" },
  { pattern: /\bcases?\b/, type: "case" },
  { pattern: /\bspeakers?\b/, type: "speaker" },
